  ...
  return (
    ...
    >
      <div className="max-w-2xl w-full text-center flex flex-col items-center gap-8">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-3 px-8 py-4 bg-primary text-on-primary rounded-xl font-medium hover-lift-btn transition-all duration-250 shadow-sm"
        >
